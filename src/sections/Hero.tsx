...
export const Hero = () => {
  ...
  return (
    <section
      id="home"
      ref={sectionRef}
      className="relative py-[72px] md:py-24 text-white bg-[linear-gradient(to_bottom,#000,#200d42_34%,#4f21a1_65%,#a46edb_82%)] overflow-clip"
    >
      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            ...
            {/* ✅ Render draggable elements only after client mount */}
            {isMounted && (
              <>
                <motion.div
                  drag
