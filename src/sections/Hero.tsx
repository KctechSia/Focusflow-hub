...
export const Hero = () => {
  return (
    <section className="relative py-[72px] md:py-24 text-white bg-[linear-gradient(to_bottom,#000,#200d42_34%,#4f21a1_65%,#a46edb_82%)] overflow-clip">
      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            ...
            <Image src={cursorImage} alt="Cursor image" className="size-[200px] absolute right-[476px] top-[108px] hidden md:inline" />
            <Image src={messageImage} alt="Message image" className="size-[200px] absolute left-[498px] top-[56px] hidden md:inline" />
          </div>
        </div>
